/**
 * This class allows react native to instantiate our PieChartView class
 * as needed when we render it from JS
 *
 */
...
public class PieChartManager extends SimpleViewManager<PieChartView> {
    ...
    //Determines the name of the component within our JS
